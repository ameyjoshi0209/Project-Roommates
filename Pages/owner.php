...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark pt-1 pb-1">
		<a class="navbar-brand text-primary" href="../Pages/home.html" style="margin-left: 20px;">ROOMMATES</a>
		<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
			<div class="navbar-nav">
				<a href="owner-add.php"><button class="btn mt-1" id="owner-btn" style="margin-left: 25px;">
						<img src="../Img/house-add-fill.svg" class="img-fluid" width="27px"> Add</button></a>
			</div>
		</div>
		<div class="align">
	...
	<div class="container-fluid">
		<div class="row mt-3 g-3">
			...
			$records = pg_query($dbconn, "select * from property");
				...
				<div class="col-sm-4">
					<div class="card">
						<div class="card-body">
							...
							<a href="update.php?id=<?php echo $data['p_id']; ?>"><button class="btn mt-3 edit-btn">
									<img src="../Img/update.svg" class="img-fluid" height="20px" width="20px"> Update</button></a>
							<a href="delete.php?id=<?php echo $data['p_id']; ?>"><button class="btn mt-3 edit-btn">
